...
Predicate_SLAH::Predicate_SLAH(z3::func_decl fun, z3::expr_vector pars, z3::expr base, z3::expr rec)
:Predicate(pars,base,rec), m_fun(fun), m_rec_hck(z3_ctx), m_rec_app(z3_ctx){
