...
(assert(and
(distinct x67 x96) (= x91 x24) (< x35 x6) (= x54 x138) (< x36 x149) (< x87 x121) (distinct x21 x158) (< x167 x29) (distinct x29 x114) (= x93 x108) (distinct x12 x32) (< x140 x120) (distinct x20 x98) (= x153 x97) (distinct x78 x23) (distinct x69 x152) (< x146 x118) 
(sep
(pto x0 (c_data_t x1))
(hls x2 x3 v2)
(pto x4 (c_data_t x5))
