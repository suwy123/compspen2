...
(assert(and
(< x33 x105) (distinct x112 x7) (< x18 x67) (distinct x90 x112) (= x65 x89) (= x4 x166) (= x65 x58) (< x135 x137) (distinct x74 x99) (< x150 x85) (distinct x84 x83) (< x42 x115) (= x3 x14) (distinct x98 x27) (distinct x143 x135) 
(sep
(hls x0 x1 v0)
(pto x2 (c_data_t x3))
(blk x4 x5)
