...
(assert(and
(distinct x137 x38) (= x65 x80) (= x10 x91) (< x6 x19) (distinct x65 x78) (= x110 x105) (< x43 x11) (= x138 x39) (distinct x139 x136) (distinct x93 x15) (= x0 x94) (< x114 x83) (< x46 x33) (distinct x46 x67) (= x137 x38) (distinct x104 x101) (distinct x23 x53) 
(sep
(blk x0 x1)
(hls x2 x3 v2)
(blk x4 x5)
