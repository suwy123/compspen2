...
(assert(and
(= x51 x87) (< x47 x150) (< x72 x151) (< x76 x128) (< x70 x47) (< x101 x25) (= x146 x64) (< x32 x88) (= x88 x114) (< x121 x152) (distinct x109 x134) (distinct x146 x84) (distinct x43 x147) (= x111 x17) (< x115 x56) 
(sep
(hls x0 x1 v0)
(pto x2 (c_data_t x3))
(hls x4 x5 v4)
